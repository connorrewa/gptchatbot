...
const API_KEY = "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"

function ClearChatButton ({ onClearChat }) {
  return (
    <Button 
      border onClick = {onClearChat}
      style = {{margin : '10px'}}
      >
        Clear chat
    </Button>
...
function App() {
  ...
  const [messages, setMessages] = useState([
    {
      message: "Hello, ask me a question...",
      sender: "ChatGPT"
    }
